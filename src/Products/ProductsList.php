...
class ProductsList
{
     ...
     * @param bool $bypassLimit
     * @return mixed
     * @throws \Exception
     */
    public function listProducts($start, $limit, $search = null, $forceCount = false, $bypassLimit = false){
        // Sanity check
        ...
        // Set data
        $data = array('start' => $start, 'limit' => $limit, 'forceCount' => $forceCount, 'bypassLimit' => $bypassLimit);
